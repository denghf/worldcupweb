...
| **【本次更新】下注详情赛事概览** | 按赛事查看当前筛选下的赔率选项和下注明细 | 点击赔率高亮对应下注，点击下注联动左侧详情 |
...
| 下注详情 | 默认展示该场赛事在当前筛选条件下的全部下注记录，并显示总条数 |
| 点击赔率选项 | 高亮下注详情中与该赔率选项匹配的下注记录，匹配维度为 matchId + betMarket + selectedOption |
| 点击下注记录 | 联动左侧下注列表：展开对应注单，滚动到对应下注项，并高亮该下注项 |
| 切换筛选条件 | 左侧下注列表和右侧赛事下注概览同步刷新，清空当前赔率选中态和下注高亮态 |
...
| lockedOdds | decimal | 是 | 下注时锁定赔率 |
| userNickname | string | 是 | 下注详情展示用 |
| totalAmount | decimal | 是 | 下注金额展示用 |
| result | enum | 是 | pending / won / lost / cancelled |
