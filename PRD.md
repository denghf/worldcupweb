...
> > 最后更新：2026-06-02
> 版本：v2.2 【本次更新】移除用户注册/登录，改为完全公开访问；管理员硬编码登录
...
| total_amount | decimal(10,2) | ≥1 | 是 | - | 正数 | 金额 ≥ 1欢乐豆 |
...
**功能描述**：每个用户的欢乐豆余额和流水记录。管理员可手动充值/扣减。不接入任何支付通道。
...
**功能描述**：比赛结束后，系统从 API-Football 拉取赛果，自动结算所有相关下注单，中奖的发放欢乐豆，更新排名。
